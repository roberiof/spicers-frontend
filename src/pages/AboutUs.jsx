  ...
  return(
    <WrapperContent h1PrimaryColor={true} isParagraphLight={true}>
      ...
      <div style={{marginTop: '2rem'}}>
        <h3 data-aos="flip-left">Our Mission</h3>
      ...
      <div style={{marginTop: '2rem'}}>
        <h3 data-aos="flip-left">Our Guarantee</h3>
      ...
      <div style={{marginTop: '2rem'}}>
        <h3 data-aos="flip-left"> The Spicers’ Difference</h3>
      ...
      <div style={{marginTop: '2rem'}}>
        <h3 data-aos="flip-left">Working Together</h3>
